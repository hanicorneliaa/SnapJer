...
public class RecipePageIngredients extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recipe_page_ingredients);
        ...
        ingredientsBtn.setTextColor(Color.parseColor("#A80D1A"));
        ...
        for (int j = 0; j < ingredients.size(); j++) {
            recipe_ingredients.append(j+1 +")  " + ingredients.get(j) + "\n" + "\n");
        }
